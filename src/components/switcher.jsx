...
export default function Swithcer() {
    ...
    return(
        <>
            <button onClick={() => setTheme(colorTheme)} className="fixed top-10 right-10 focus:outline-none">
                <img src={ colorTheme === 'light' ? night : day } alt="switch" width="40" />
            </button>
            <a href="https://www.linkedin.com/in/omerduraker/" target="_blank" rel="noreferrer" className="bg-white dark:bg-gray-800 m-4 rounded-lg shadow-lg">
